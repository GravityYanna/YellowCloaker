...
if ($black_land_use_custom_thankyou_page) {
    $black_land_log_conversions_on_button_click = false;
}
...
$tt_conversion_pixel = $conf['pixels.tt.conversion.fireonbutton'];
